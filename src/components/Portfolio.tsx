...
const portfolioWorks = [
  {
    ...
    description: 'An ornate peacock rendered in traditional Madhubani style with intricate geometric tail feathers. The peacock symbolizes beauty, grace, and the eternal dance of nature in Mithila tradition.',
  ...
  },
  {
    ...
    category: 'Mythology',
    description: 'A powerful depiction of the goddess seated on a lotus, surrounded by sacred symbols. Each element carries deep spiritual significance rooted in centuries of Mithila devotional practice.',
  ...
  },
  {
    ...
    description: 'The cosmic tree connecting earth and heaven, flanked by elephants and adorned with birds. In Madhubani tradition, the Tree of Life represents the interconnectedness of all living things.',
    medium: 'Natural Dyes on Handmade Paper',
    dimensions: '28 × 38 inches',
  },
  {
    id: 4,
    ...
    description: 'A woman in traditional dress flying a kite, celebrating the joy and freedom of folk life. This piece bridges the gap between traditional Madhubani narrative and contemporary expression.',
  ...
  },
  {
    ...
    category: 'Mythology',
    description: 'Goddess Lakshmi in contemplative meditation, rendered in dramatic black and white linework. The stark contrast emphasizes the duality of material and spiritual abundance.',
    medium: 'Pen & Ink on Handmade Paper',
  ...
  },
  {
    ...
    category: 'Sacred Motifs',
    description: 'Twin fish swimming in eternal harmony, a symbol of fertility and prosperity in Mithila art. The mandala framework places the fish within a cosmic geometric order.',
